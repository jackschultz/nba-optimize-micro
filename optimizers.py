...
def standard(date, site='fd', exclude=[]):
    ...
    df = get_stat_lines_for_date(date,exclude=exclude)
    ...
    actual_points, actual_salary = get_actual_points_sal_for_ids(top_pids, date)
    actuals = {}
